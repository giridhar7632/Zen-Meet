  ...
  return (
    <Layout meta={{ name: 'Privacy Policy' }}>
      <div className="prose xl:prose-lg mx-auto">
        ...
        <p>
          {' '}
          MeetMate (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy
        ...
        <p>
          ...
          our “Service”) alongside our application, MeetMate. By accessing or using our Service, you
        ...
        <p>
          ...
          MeetMate. We also occasionally collect information that is made publicly available on
        ...
        <p>
          ...
          of any information you transmit to MeetMate or guarantee that your information on the
        ...
        <p>
          ...
          depend on your relationship with MeetMate. Personnel may update or correct their
        ...
        <h2>Personnel</h2>
        <p>
          If you are a MeetMate worker or applicant, we collect information you voluntarily provide
        ...
        <p>
          ...
          merger or other transfer of all or substantially all of the assets of MeetMate or any of
          its Corporate Affiliates (as defined herein), or that portion of MeetMate or any of its
        ...
        <p>
          ...
          common control with MeetMate, whether by ownership or otherwise. Any information relating
        ...
        <h2>Cookies</h2>
        <p>
          MeetMate uses &quotCookies&quot to identify the areas of our website that you have
        ...
        <p>
          ...
          simply the right thing to do. At MeetMate we strongly believe that your data privacy is
        ...
        <p>
          ...
          of GDPR. MeetMate processes or stores all personal data in fully vetted, DPA compliant
