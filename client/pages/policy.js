const privacyPolicy = () => {
  return (
    <div className="prose xl:prose-lg mx-auto">
      ...
      <p>
        {' '}
        MeetMate (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
        explains how your personal information is collected, used, and disclosed by Sell Easy.
      </p>
      <p>
        This Privacy Policy applies to our website, and its associated subdomains (collectively, our
        “Service”) alongside our application, MeetMate. By accessing or using our Service, you
      ...
      <ul>
        ...
        <li>
          Country: where MeetMate or the owners/founders of MeetMate are based, in this case is
          India
        </li>
        <li>
          Customer:refers to the company, organization or person that signs up to use the Sell Easy
        ...
        <li>
          ...
          that can be used to visit MeetMate and use the services.
        </li>
        <li>
        ...
        <li>
          Personnel:refers to those individuals who are employed by MeetMate or are under contract
      ...
      <p />
      <h2>When does MeetMate use end user information from third parties?</h2>
      <p>
        MeetMate will collect End User Data necessary to provide the MeetMate services to our
        customers.
      </p>
      <p>
      ...
      <h2>When does MeetMate use customer information from third parties?</h2>
      <p>
        We receive some information from the third parties when you contact us. For example, when
        you submit your email address to us to show interest in becoming a MeetMate customer, we
        receive information from a third party that provides automated fraud detection services to
        MeetMate. We also occasionally collect information that is made publicly available on social
      ...
      <p>
        MeetMate will collect personal information that you submit to us. We may also receive
      ...
      <p>
        We keep your information only so long as we need it to provide MeetMate to you and fulfill
      ...
      <p>
        ...
        any information you transmit to MeetMate or guarantee that your information on the Service
      ...
      <p>
        MeetMate is incorporated in India. Information collected via our website, through direct
      ...
      <h2>Is the information collected through the MeetMate Service secure?</h2>
      <p>
      ...
      <p>
        The rights you have to request updates or corrections to the information MeetMate collects
        depend on your relationship with MeetMate. Personnel may update or correct their information
      ...
      <h2>Personnel</h2>
      <p>
        If you are a MeetMate worker or applicant, we collect information you voluntarily provide to
      ...
      <p>
        ...
        or other transfer of all or substantially all of the assets of MeetMate or any of its
        Corporate Affiliates (as defined herein), or that portion of MeetMate or any of its
      ...
      <p>
        ...
        control with MeetMate, whether by ownership or otherwise. Any information relating to you
      ...
      <p>
        By using MeetMate or contacting us directly, you signify your acceptance of this Privacy
      ...
      <p>
        ...
        websites not operated or controlled by MeetMate. We are not responsible for the content,
      ...
      <h2>Cookies</h2>
      <p>
        MeetMate uses &quotCookies&quot to identify the areas of our website that you have visited.
      ...
      <p>
        ...
        simply the right thing to do. At MeetMate we strongly believe that your data privacy is very
      ...
      <p>
        ...
        GDPR. MeetMate processes or stores all personal data in fully vetted, DPA compliant vendors.
